...
type User struct {
	...
	Followers                 []Connection     `gorm:"foreignKey:ReceiverID;constraint:OnDelete:CASCADE" json:"-"`
	Following                 []Connection     `gorm:"foreignKey:SenderID;constraint:OnDelete:CASCADE" json:"-"`
}
